...
Public Class frmChange
    ...
    Private Sub cmbRun_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbRun.Click
        ...
        If Not (dbTools.getSizecode(txtStkCode.Text) = dbTools.getSizecode(lbStkCode2.Text)) Then
        ...
        If Not (dbTools.getTHcode(txtStkCode.Text) = dbTools.getTHcode(lbStkCode2.Text)) Then
        ...
        Else
            ...
            If MsgBox("แจ้งเตือน การทำการเปลี่ยนแปลงรหัสสินค้าและชื่อสินค้า อาจจะมีผลกับข้อมูลการขายสินค้า ", MsgBoxStyle.YesNo, "แจ้งเตือน") = MsgBoxResult.Yes Then
                Call changeCode(txtStkCode.Text, lbStkCode2.Text)
                txtStkCode.Text = ""
                lbStkName.Text = ""
                lbStkCode2.Text = ""
                lbStkName2.Text = ""
    ...
    Sub changeCode(ByVal strCode0 As String, ByVal strNewCode As String)
        ...
        txtSQL = txtSQL & "Where stk_code='" & strCode0 & "' "

        dbTools.dbDelSQLsrv(txtSQL, dbTools.getStkName(strCode0 & " ในการเปลี่ยนประวัติ"))

        OLD_stock_PA = dbTools.getStock(strNewCode, "110098", "01")
        OLD_stock_VK = dbTools.getStock(strNewCode, "110098", "12")


        Stock_PA = dbTools.getStock(strCode0, "110098", "01")
        Stock_VK = dbTools.getStock(strCode0, "110098", "12")
        ...
        txtSQL = txtSQL & "Where Dtl_Code ='" & strNewCode & "' "

        dbTools.dbDelSQLsrv(txtSQL, dbTools.getStkName(strNewCode & " ในการเปลี่ยนประวัติ"))


        ' 3. เปลี่ยน รหัสเก่า เป็น  รหัสใหม่ ใน StkDetl

        txtSQL = "Update StkDetl "
        txtSQL = txtSQL & "Set dtl_code='" & strNewCode & "', Dtl_Bal_Q1='" & Stock_PA & "' "
        txtSQL = txtSQL & "Where dtl_code='" & strCode0 & "'  And dtl_wh='01' "

        dbTools.dbSaveSQLsrv(txtSQL, dbTools.getStkName(strCode0 & " ในการเปลี่ยนประวัติ"))

        txtSQL = "Update StkDetl "
        txtSQL = txtSQL & "Set dtl_code='" & strNewCode & "', Dtl_Bal_Q1='" & Stock_VK & "' "
        txtSQL = txtSQL & "Where dtl_code='" & strCode0 & "' And dtl_wh='12' "
        ...
        txtSQL = txtSQL & "Set dtl_idTrade ='" & strNewCode & "' "
        txtSQL = txtSQL & "Where dtl_idTrade='" & strCode0 & "' "
        dbTools.dbSaveSQLsrv(txtSQL, dbTools.getStkName(strCode0 & " ในการเปลี่ยนประวัติ"))

        txtSQL = "Update CostMast "
        txtSQL = txtSQL & "Set CS_Stk_Code ='" & strNewCode & "' "
        txtSQL = txtSQL & "Where CS_Stk_Code='" & strCode0 & "' "
        dbTools.dbSaveSQLsrv(txtSQL, dbTools.getStkName(strCode0 & " ในการเปลี่ยนประวัติ"))
    ...
    Sub ShowData()
        ...
        Try
            ...
            txtStkCode.Text = subDS.Tables("Master").Rows(0).Item("Stk_Code")
    ...
    Sub ShowData2()
        ...
        Try
            ...
            lbStkCode2.Text = subDS.Tables("Master2").Rows(0).Item("Stk_Code")

            lbStkPA02.Text = dbTools.getStock(lbStkCode2.Text, "110098", "01")
            lbStkVK02.Text = dbTools.getStock(lbStkCode2.Text, "110098", "12")
        Catch ex As Exception
    ...
    Private Sub lsvShow_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lsvShow.SelectedIndexChanged
        ...
        For i = 0 To lsvShow.SelectedItems.Count - 1
            ...
            txtStkCode.Text = lsvShow.Items(stkSelect.Index).SubItems(1).Text
            lbStkName.Text = lsvShow.Items(stkSelect.Index).SubItems(2).Text
            lsvShow.Items.Remove(stkSelect)
            lbStkPA01.Text = dbTools.getStock(txtStkCode.Text, "110098", "01")
            lbStkVK01.Text = dbTools.getStock(txtStkCode.Text, "110098", "12")
