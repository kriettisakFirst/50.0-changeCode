...
Module dbTools
    ...
    End Function
    Function getTHcode(ByVal StkCode As String) As String
        ...
        Ans = subDS.Tables("command").Rows(0).Item("Th_Code")
        subDS = Nothing
        subDA = Nothing
        ...
        Return Ans
    End Function
    Function getSizecode(ByVal StkCode As String) As String
        ...
        Ans = subDS.Tables("command").Rows(0).Item("Size_Code")
        subDS = Nothing
        subDA = Nothing
    ...
    Function getSG(ByVal typId As String) As Double
        ...
        Else
            txtSQL = "Select * "
            txtSQL &= "From TypeMast "

            txtSQL &= "WHERE ((Type_code='" & typId & "'))"

            subDA = New SqlClient.SqlDataAdapter(txtSQL, Conn)
            subDA.Fill(subDS, "TypeList")

            ans = subDS.Tables("TypeList").Rows(0).Item("Type_SG")
    ...
    Function chkStkDetl(ByVal stkCode As String) As Boolean
        ...
        subDA = New SqlClient.SqlDataAdapter(txtSQL, Conn)
        subDA.Fill(subDS, "DSet")

        If subDS.Tables("DSet").Rows.Count > 0 Then
            Return True
        Else
            Return False
        End If
